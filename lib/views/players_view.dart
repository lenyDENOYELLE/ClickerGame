...
class _PlayerViewState extends State<PlayerView> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<PlayerListViewModel>(context, listen: false).fetchUsers();
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Consumer<PlayerListViewModel>(
            ...
            if (viewModel.isLoading) {
              ...
              return Column(
                ...
                children: [
                  ...
                  // Bouton Ajouter
                  ElevatedButton.icon(
                    onPressed: () => _showPlayerForm(context, viewModel),
  ...
  void _confirmDelete(BuildContext context, PlayerListViewModel viewModel, int PlayerId) {
    showDialog(
      context: context,
      builder: (context) {
        return AlertDialog(
